			...
			<div className="container w-[75%] mx-auto px-4">
					...
					{properties.map((property) => (
						...
						>
							<div className="relative">
								...
								/>
								<div className="absolute top-4 left-4 bg-[#0B0B1F] text-white px-3 py-2 rounded-md font-semibold">
									{property.type}
								</div>
							...
							<div className="px-6 pb-6">
								<button className="w-full bg-blue-600 hover:bg-blue-700 text-white py-3 rounded-md transition-colors font-medium text-lg">
									View Details
								</button>
							</div>
						</div>
				...
				<div className="text-center mt-12">
					<a
						...
						className="inline-block bg-[#0B0B1F] hover:bg-blue-800 text-white px-8 py-3 rounded-md transition-colors font-medium text-xl"
					>
						View All Properties
					</a>
				</div>
