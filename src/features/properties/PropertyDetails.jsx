...
// 					<div className="w-full md:w-[65%]">
// 						<div className="bg-white p-6 rounded-lg md:rounded-xl mb-10">
// 							<ImageSlider imageList={property.detailImages} />
// 						</div>
// 						<div className="w-full p-7 bg-white rounded-md my-10">
// 							<p className="text-4xl font-semibold mb-10">Overview</p>
// 							<div className="w-full flex justify-between items-center">
...
// 						<div className="w-full p-7 bg-white rounded-md my-10">
// 							<p className="text-4xl font-semibold mb-10">Description</p>
// 							<p className="text-2xl text-gray-400">{property.description}</p>
// 						</div>
...
// 					<div className="w-full md:w-[35%]">
// 						<div className="w-full p-7 bg-white rounded-md mb-10">
// 							<p className="text-4xl font-semibold mb-10">Features</p>
// 							<div className="flex flex-wrap justify-start gap-5 items-start">
// 								<p className="text-2xl text-gray-300 pr-10 md:text-2xl md:pr-18 flex items-center gap-3">
// 									<AirVent className="text-blue-950" />
// 									<span className=" text-gray-400 font-semibold">
// 										Air Condition
// 									</span>
// 								</p>
// 								<p className="text-2xl text-gray-300 pr-10 md:text-2xl md:pr-18 flex items-center gap-3">
// 									<Dumbbell className="text-blue-950" />
// 									<span className=" text-gray-400 font-semibold">Gym</span>
// 								</p>
// 								<p className="text-2xl text-gray-300 pr-10 md:text-2xl md:pr-18 flex items-center gap-3">
...
// 								</p>
// 								<p className="text-2xl text-gray-300 pr-10 md:text-2xl md:pr-18 flex items-center gap-3">
// 									<Wine className="text-blue-950" />
// 									<span className=" text-gray-400 font-semibold">Bar</span>
// 								</p>
// 								<p className="text-2xl text-gray-300 pr-10 md:text-2xl md:pr-18 flex items-center gap-3">
// 									<CctvIcon className="text-blue-950" />
// 									<span className=" text-gray-400 font-semibold">CCTV</span>
// 								</p>
// 								<p className="text-2xl text-gray-300 pr-10 md:text-2xl md:pr-18 flex items-center gap-3">
// 									<LockKeyhole className="text-blue-950" />
// 									<span className=" text-gray-400 font-semibold">Security</span>
// 								</p>
// 								<p className="text-2xl text-gray-300 pr-10 md:text-2xl md:pr-18 flex items-center gap-3">
// 									<Volleyball className="text-blue-950" />
// 									<span className=" text-gray-400 font-semibold">
// 										Sports Area
// 									</span>
// 								</p>
// 								<p className="text-2xl text-gray-300 pr-10 md:text-2xl md:pr-18 flex items-center gap-3">
// 									<Trees className="text-blue-950" />
// 									<span className=" text-gray-400 font-semibold">Garden</span>
// 								</p>
// 							</div>
// 						</div>

// 						<div className="w-full p-7 bg-white rounded-md my-10">
// 							<p className="text-4xl font-semibold mb-10">Contact Agent</p>
// 							<form className="w-full">
// 								<div className="mb-6">
// 									<input
// 										type="text"
// 										placeholder="Your Name"
// 										className="w-full p-4 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-950"
// 									/>
// 								</div>
// 								<div className="mb-6">
// 									<input
...
// 								<button
// 									type="submit"
// 									className="w-full bg-blue-950 hover:bg-blue-900 text-white py-4 rounded-md transition-colors font-medium text-xl"
// 								>
// 									Send Message
// 								</button>
// 							</form>
...
// 				{/* Google Maps Section */}
// 				<div className="w-full p-7 bg-white rounded-md my-10">
// 					<p className="text-4xl font-semibold mb-10">Location</p>
// 					<div className="w-full h-[400px] bg-gray-200 rounded-md">
// 						{/* Google Maps would be integrated here */}
// 						<div className="w-full h-full flex justify-center items-center">
// 							<p className="text-2xl text-gray-500">Google Maps Integration</p>
// 						</div>
// 					</div>
// 				</div>
// 			</div>
