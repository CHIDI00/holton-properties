...
const FooterContent = () => {
	return (
		<div className="w-screen py-5 bg-[#060830]">
			<div className="container mx-auto">
				...
				<div className="w-full flex flex-col">
					<div className="w-full  flex flex-col md:flex-row">
						<div className="px-7 w-full md:w-[50%] mt-7 flex flex-col justify-start items-start">
							...
							<div className=" flex flex-col gap-4 justify-start items-start">
								...
								<div className="flex gap-10">
									<button className="h-16 w-16 bg-white flex justify-center items-center rounded-full hover:bg-red-500 hover:text-white transition-all">
										<Facebook />
									</button>
									<button className="h-16 w-16 bg-white flex justify-center items-center rounded-full hover:bg-red-500 hover:text-white transition-all">
										<Instagram />
